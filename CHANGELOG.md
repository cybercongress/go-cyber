...
- Bump tendermint/cosmos-sdk to 0.32.8/0.37.4 [\#437](https://github.com/cybercongress/cyberd/issues/437)
- Add overall karma stats [\#435](https://github.com/cybercongress/cyberd/issues/435)
- Add instructions for easy install and use non-validating version of cyberdcli [\#425](https://github.com/cybercongress/cyberd/issues/425)
- euler-x params discussion [\#422](https://github.com/cybercongress/cyberd/issues/422)
- Add rank and bandwidth modules LCD endpoints [\#419](https://github.com/cybercongress/cyberd/issues/419)
- Add max block bandwidth parameter [\#415](https://github.com/cybercongress/cyberd/issues/415)
- Make cross testing of data preparation code for GPU [\#413](https://github.com/cybercongress/cyberd/issues/413)
- Fix CLI output on txs [\#412](https://github.com/cybercongress/cyberd/issues/412)
- Add Makefile for rank CUDA kernel [\#409](https://github.com/cybercongress/cyberd/issues/409)
- CUDA kernel for Rank Merkle Tree calculation [\#401](https://github.com/cybercongress/cyberd/issues/401)
- Sync fail due to possible DB corruption  [\#397](https://github.com/cybercongress/cyberd/issues/397)
- Add instructions to use without docker [\#389](https://github.com/cybercongress/cyberd/issues/389)
- Update docs on inflation params from euler-5 [\#385](https://github.com/cybercongress/cyberd/issues/385)
- Ability to launch validator from blockchain backup [\#384](https://github.com/cybercongress/cyberd/issues/384)
- Top CIDs endpoint [\#378](https://github.com/cybercongress/cyberd/issues/378)
- Index of used by account bandwidth for linking [\#371](https://github.com/cybercongress/cyberd/issues/371)
- Snapshot of Cosmos Hub for euler-5 [\#369](https://github.com/cybercongress/cyberd/issues/369)
- Configure BIP44 path [\#368](https://github.com/cybercongress/cyberd/issues/368)
- Get actual data on euler-4 validators uptime [\#360](https://github.com/cybercongress/cyberd/issues/360)
- Set size limit for CIDv1 [\#346](https://github.com/cybercongress/cyberd/issues/346)
- Prepare genesis for euler-5 with proofs flow [\#339](https://github.com/cybercongress/cyberd/issues/339)
- Adjust consensus and cyberd params for euler-5 [\#338](https://github.com/cybercongress/cyberd/issues/338)
- Add table of seed/validator nodes to README for euler-4 [\#319](https://github.com/cybercongress/cyberd/issues/319)
- Advanced export [\#318](https://github.com/cybercongress/cyberd/issues/318)
- Make profiling [\#317](https://github.com/cybercongress/cyberd/issues/317)
- Move bandwidth logic to ante handler [\#249](https://github.com/cybercongress/cyberd/issues/249)
- Download genesis files on start of docker container [\#224](https://github.com/cybercongress/cyberd/issues/224)
- Refactor daemon/cmd package [\#199](https://github.com/cybercongress/cyberd/issues/199)
- index stats rpc add block time fields [\#176](https://github.com/cybercongress/cyberd/issues/176)

**Merged pull requests:**

- 0.1.5 docs cleanup [\#439](https://github.com/cybercongress/cyberd/pull/439) ([mrlp4](https://github.com/mrlp4))
- Bump cosmos-sdk and tendermint versions [\#438](https://github.com/cybercongress/cyberd/pull/438) ([litvintech](https://github.com/litvintech))
- Added used overall karma generated by agents [\#436](https://github.com/cybercongress/cyberd/pull/436) ([litvintech](https://github.com/litvintech))
- Implemented top cids endpoint and top processing [\#434](https://github.com/cybercongress/cyberd/pull/434) ([litvintech](https://github.com/litvintech))
- run\_validator\_fixes [\#432](https://github.com/cybercongress/cyberd/pull/432) ([mrlp4](https://github.com/mrlp4))
- add Tendermint KMS  with Leger validator setup [\#431](https://github.com/cybercongress/cyberd/pull/431) ([mrlp4](https://github.com/mrlp4))
- Update README.md [\#430](https://github.com/cybercongress/cyberd/pull/430) ([serejandmyself](https://github.com/serejandmyself))
- ledger\_guide\_cyberd [\#428](https://github.com/cybercongress/cyberd/pull/428) ([mrlp4](https://github.com/mrlp4))
- create run\_validator for euler-dev testnet [\#427](https://github.com/cybercongress/cyberd/pull/427) ([mrlp4](https://github.com/mrlp4))
- Remove outdated whitepaper [\#424](https://github.com/cybercongress/cyberd/pull/424) ([xhipster](https://github.com/xhipster))
- 419 band and rank modules endpoints [\#420](https://github.com/cybercongress/cyberd/pull/420) ([litvintech](https://github.com/litvintech))
- Client upgrade [\#418](https://github.com/cybercongress/cyberd/pull/418) ([litvintech](https://github.com/litvintech))
- Added stat for used for linking band [\#417](https://github.com/cybercongress/cyberd/pull/417) ([litvintech](https://github.com/litvintech))
- \#320 add advanced guides [\#390](https://github.com/cybercongress/cyberd/pull/390) ([SaveTheAles](https://github.com/SaveTheAles))

## [v0.1.5-t](https://github.com/cybercongress/cyberd/tree/v0.1.5-t) (2019-11-01)
[Full Changelog](https://github.com/cybercongress/cyberd/compare/v0.1.5-rc1...v0.1.5-t)

## [v0.1.5-rc1](https://github.com/cybercongress/cyberd/tree/v0.1.5-rc1) (2019-11-01)
[Full Changelog](https://github.com/cybercongress/cyberd/compare/euler-5rc1...v0.1.5-rc1)

**Merged pull requests:**

- Added max block band params and validation [\#421](https://github.com/cybercongress/cyberd/pull/421) ([litvintech](https://github.com/litvintech))
- 318 advanced export [\#416](https://github.com/cybercongress/cyberd/pull/416) ([litvintech](https://github.com/litvintech))
