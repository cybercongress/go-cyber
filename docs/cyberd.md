...
Obviously, the cryptoeconomic approach can change beneficiaries in this game. Thus it effectively removes possible sybil attack vectors and eradicates the necessity to make a decision on example of centralized ranking of web pages on the basis of analysis of content and user behavior. Learning sybil-resilient model will probably lead to more predictive results.
