...
Obviously, the cryptoeconomic approach can change beneficiaries in this game. Thus it effectively removes possible sybil attack vectors and eradicates the necessity to make a decision. For example, crawling and meaning extraction from one entity to the whole world. Learning sybil-resilient model will probably lead to more predictive results.
