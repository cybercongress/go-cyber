...
In this paper, we: (1) define a protocol for provable consensus computing of relevance between IPFS objects based on Tendermint consensus and cyber•rank computed on GPU, (2) discuss implementation details (3) and design distribution and incentive scheme based on our experience.
