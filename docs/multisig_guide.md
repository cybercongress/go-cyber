...
To follow this guide you'll need `cyberdcli` installed and connected to any cyberd node (refer to our cli [guide](https://cybercongress.ai/docs/cyberd/ultimate-commands-guide/)).
