...
It is possible to use your Ledger device with pussy to store keys and sign transactions.

## Pussyd CLI & Ledger Nano

How to get started. First of all, you'll need a couple of things to be done:

+ A running and synced pussy node (how to: [here](https://github.com/joinresistance/space-pussy/blob/main/docs/run_validator.md) and [here](https://github.com/joinresistance/space-pussy/blob/main/docs/ultimate-commands-guide.md))
...
- name: <your_key_name>
  type: ledger
  address: pussy1gw5kdey7fs9wvh05w66s034s24tjdvxcp5fhkz
  pubkey: pussypub1addwnpepq0lfpdumac47nyel06u95czd4026ahzmjr8stsx4h65kw3dhh60py0m7k6r
  mnemonic: ""
  threshold: 0
  pubkeys: []
  ```
...
``` js
pussy keys add <your_key2_name> --ledger --account 1 --index 1
```
...
``` js
pussy tx bank send <from_key_name> <destination_address> <ammount>pussy --chain-id <current_chain_id>
```

`<from_key_name>` is your ledger key name, `<destination_address>` is the address of the recipient in the following format: `pussy1wq7p5qfygxr37vqqufhj5fzwlg55zmm4w0p8sw`.
