...
var (
	...
	ErrInvalidRoute  = sdkerrors.Register(ModuleName, 10, "invalid route")
	ErrConvertTrigger  = sdkerrors.Register(ModuleName, 11, "cannot convert trigger")
	ErrExceededMaxJobs  = sdkerrors.Register(ModuleName, 12, "exceeded max jobs")
)
