...
var (
	ErrTimeLockCoins       = sdkerrors.Register(ModuleName, 2, "error timelock coins")
	...
	ErrNotAvailablePeriod  = sdkerrors.Register(ModuleName, 7, "period not available")
	...
	ErrResourceNotExist    = sdkerrors.Register(ModuleName, 10, "resource does not exist")
	ErrFullSlots           = sdkerrors.Register(ModuleName, 11, "all slots are full")
	ErrSmallReturn         = sdkerrors.Register(ModuleName, 12, "insufficient resources return amount")
