...
var (
	...
	pattern_Query_Account_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 1, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"cyber", "bandwidth", "v1beta1", "neuron", "address"}, "", runtime.AssumeColonVerbOpt(false)))
