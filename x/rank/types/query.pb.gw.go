...
var (
	...
	pattern_Query_Negentropy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"cyber", "rank", "v1beta1", "negentropy"}, "", runtime.AssumeColonVerbOpt(true)))
