...
var (
	filter_Query_SourceRoutes_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
var (
	filter_Query_DestinationRoutes_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
var (
	filter_Query_DestinationRoutedEnergy_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
var (
	filter_Query_SourceRoutedEnergy_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
var (
	filter_Query_Route_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
var (
	filter_Query_Routes_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 1, 2, 3}, []string{"cyber", "energy", "v1beta1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SourceRoutes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 1, 2, 3}, []string{"cyber", "energy", "v1beta1", "source_routes"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_DestinationRoutes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 1, 2, 3}, []string{"cyber", "energy", "v1beta1", "destination_routes"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_DestinationRoutedEnergy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 1, 2, 3}, []string{"cyber", "energy", "v1beta1", "destination_routed_energy"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SourceRoutedEnergy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 1, 2, 3}, []string{"cyber", "energy", "v1beta1", "source_routed_energy"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Route_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 1, 2, 3}, []string{"cyber", "energy", "v1beta1", "route"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Routes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 1, 2, 3}, []string{"cyber", "energy", "v1beta1", "routes"}, "", runtime.AssumeColonVerbOpt(false)))
)
