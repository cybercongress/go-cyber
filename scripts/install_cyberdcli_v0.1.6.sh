#!/bin/sh
# Installation script for cybercli. It tries to move binaries in one of the
  ...
  "Darwin")
    ...
    for binpath in $binpaths; do
      if tar -xzf go_cyber_v0.1.6_darwin-amd64.tar.gz -C "$binpath"; then
        echo "Moved cybercli to $binpath"
...
echo "We cannot install cybercli in one of the directories $binpaths"
