...
import (
	...
	authzcodec "github.com/cybercongress/go-cyber/x/tokenfactory/types/authzcodec"
...
func (s *KeeperTestHelper) Setup() {
	...
	s.Ctx = s.App.BaseApp.NewContext(false, tmtypes.Header{Height: 1, ChainID: "bostrom", Time: time.Now().UTC()})
