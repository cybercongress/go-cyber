...
func (app *CyberdApp) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string,
...
func (app *CyberdApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
	...
	store := ctx.KVStore(app.dbKeys.stake)
