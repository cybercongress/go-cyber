...
```
{"key":"agent","chain-id":"bostrom-testnet-5","rpc-addr":"http://195.201.105.229:26657/","account-prefix":"bostrom","gas-adjustment":1.5,"gas-prices":"0.01boot","trusting-period":"72h"}
```
_________________________________________________________
